export const queryReturnAddressList = '/config/SysReturnAddress/queryReturnAddressList'; // 获取寄回地址列表页
export const deleteReturnAddress = ['/config/SysReturnAddress/deleteReturnAddress', { methods: 'get' }]; // 寄回地址删除
