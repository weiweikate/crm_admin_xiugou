...
// 人数不足条件
export const updateStoreStarDemotionWeekDealerById = '/admin/storeStar/updateStoreStarDemotionWeekDealerById';
// 人数达标奖励
export const updateStoreStarDemotionDealerById = '/admin/storeStar/updateStoreStarDemotionDealerById';
// 分红奖励
export const updateStoreStarUpgradeBonusById = '/admin/storeStar/updateStoreStarUpgradeBonusById';
// 单笔订单交易额
export const updateStoreStarUpgradeOrderById = '/admin/storeStar/updateStoreStarUpgradeOrderById';
// 周期交易频率
export const updateStoreStarDemotionWeekSalesById = '/admin/storeStar/updateStoreStarDemotionWeekSalesById';
// 周期交易额
export const updateStoreStarDemotionTotleSalesById = '/admin/storeStar/updateStoreStarDemotionTotleSalesById';
// 无交易额条件
export const updateStoreStarDemotionWeekNoSaleById = '/admin/storeStar/updateStoreStarDemotionWeekNoSaleById';
// 根据ID查询
// export const getStoreStarById = '/admin/storeStar/getStoreStarById';
// 设置升级经验值
export const updateStoreStarUpgradeExpById = '/admin/storeStar/updateStoreStarUpgradeExpById';
// 设置必要条件
export const updateStoreStarUpgradeConditionById = '/admin/storeStar/updateStoreStarUpgradeConditionById';
// 连续交易频率达标
export const updateStoreStarUpgradeWeekSalesFreqById = '/admin/storeStar/updateStoreStarUpgradeWeekSalesFreqById';
// 连续交易额达标
