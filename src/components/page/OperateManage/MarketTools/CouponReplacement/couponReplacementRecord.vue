    ...
    <div class="deliver-coupon-record">
        ...
        <el-card class="mb10">
            <el-form :model="form" ref="form" inline label-width="120px">
                ...
                <el-form-item prop="updateUser" label="券名称">
                    <el-input v-model="form.name"></el-input>
                </el-form-item>
                <el-form-item prop="updateUser" label="券ID">
                    <el-input v-model="form.name"></el-input>
                </el-form-item>
                <el-form-item label=" ">
        ...
        <el-card>
            <el-table :data="tableData" border stripe>
                ...
                <el-table-column prop="numItems" label="券名称" align="center"></el-table-column>
                <el-table-column prop="sumTotalNum" label="券ID" align="center"></el-table-column>
