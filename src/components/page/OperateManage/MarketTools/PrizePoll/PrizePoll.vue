                    ...
                    <el-form :model="form" ref="form" inline label-width="100px">
                        ...
                        <el-form-item prop="style" label="奖品类型">
                            <el-select v-model="form.style" placeholder="全部">
                                <el-option v-for="item in prizeStyleList" :key="item.id" :label="item.name" :value="item.id"></el-option>
                            </el-select>
                        </el-form-item>
                        ...
                        <el-form-item prop="status" label="奖品状态">
                            <el-select v-model="form.status" placeholder="全部">
                                <el-option v-for="item in prizeStatusList" :key="item.id" :label="item.name" :value="item.id"></el-option>
                            </el-select>
                        </el-form-item>
                        ...
                        <el-form-item prop="updateDate" label="修改时间">
                            <el-date-picker v-model="form.updateDate" type="datetimerange" format="yyyy-MM-dd" start-placeholder="开始日期" end-placeholder="结束日期"></el-date-picker>
                        </el-form-item>
                        <el-form-item label=" ">
            ...
            <el-dialog :title="maskContent[index].title" :visible.sync="mask">
                ...
                <el-form v-model="form" label-width="120px" v-if="index==0||index==1||index==2">
                    ...
                    <el-form-item label="发放数量">
                        ...
                        <div>
                            <el-input v-model="form.upgradeExp" :disabled="form.sendNumber=='2'" placeholder="请输入数值" auto-complete="off"></el-input>
                            <span>件</span>
                        </div>
                    </el-form-item>
                </el-form>
                ...
                <el-form v-model="form" label-width="120px" v-if="index==3||index==4||index==5">
                    <el-form-item :label="maskContent[index].label">
                        ...
                        <el-autocomplete v-else style="width:230px" v-model="keyWords" :fetch-suggestions="querySearchAsync" placeholder="请输入商品名称" @select="handleSelect"></el-autocomplete>
                    </el-form-item>
                    ...
                    <el-form-item label="发放数量">
                        <el-input v-model="form.upgradeExp" placeholder="请输入数值" auto-complete="off" @blur="calInventory"></el-input>
                        <span>件</span>
