        ...
        <el-card :body-style="{ padding: '20px 45px',color:'#666' }">
            ...
            <el-form :model="form" ref="form" label-width="100px">
                ...
                <el-form-item label="产品分类">
                    <el-cascader filterable @change='getProItemId' v-model="proItemArr" :options="itemList"
                ...
                <el-form-item label="交易默认时间">
                    <transition name="fade">
                        ...
                        <el-input style='width:215px' placeholder="请输入交易默认时间" v-if="showDealTime" v-model="form.dealDays"></el-input>
                    </transition>
    ...
    export default {
        ...
        methods: {
            ...
            submitForm() {
                ...
                let data = {};
                data = this.form;
                data.url = pApi.addOperActivityPackage;
                this.btnLoading = true;
                this.$axios.post(api.addOperActivityPackage, data)
                    .then(res => {
            ...
            getFirstItem() {
                this.itemList = [];
                this.$axios
                    .post(api.getCategoryList, {fatherid: 0,type:2, url: pApi.addOperActivityPackage, pageSize: 10000})
                    .then(res => {
            ...
            getProItemId(val) {
                ...
                //获取品牌列表
                this.$axios
                    .post(api.queryCategoryBrandCid, {cId: id, url: pApi.addOperActivityPackage, pageSize: 10000})
                    .then(res => {
            ...
            getFreightTemplate() {
                ...
                this.$axios
                    .post(api.getFreightTemplateList, {url: pApi.addOperActivityPackage})
                    .then(res => {
                        res.data.data.forEach((v, k) => {
            ...
            getAllTags() {
                this.tagArr = [];
                this.$axios
                    .post(api.queryTagLibraryList, {type: 2, url: pApi.addOperActivityPackage})
                    .then(res => {
                        res.data.data.forEach((v, k) => {
