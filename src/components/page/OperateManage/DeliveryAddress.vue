<template>
    <div class="delivery-address">
        ...
        <div class="table-block">
            <el-button type="primary" style="margin-bottom: 20px" @click="addAddress" v-if="p.addStoreHouse">添加提货点</el-button>
            <template>
                <el-table :data="tableData" :height="height" border style="width: 100%">
                    ...
                    <el-table-column v-if="isShowOperate" label="操作" align="center">
                        <template slot-scope="scope">
                            <el-button type="warning" size="small" v-if="p.updateStoreHouse" @click="editItem(scope.row)">编辑</el-button>
                            <el-button type="danger" size="small" v-if="p.updateStoreHouseDeleteById" @click="delItem(scope.row.id)">删除</el-button>
                        </template>
                    </el-table-column>
                </el-table>
            </template>
        ...
        <el-dialog title="添加提货点" :visible.sync="addMask">
            <el-form v-model="addForm" label-width="100px">
                ...
                <el-form-item label="联系方式">
                    <el-input v-model="addForm.telephone" auto-complete="off" placeholder="请输入联系方式"></el-input>
                </el-form-item>
            </el-form>
        ...
        <el-dialog title="编辑提货点" :visible.sync="editMask">
            <el-form v-model="form" label-width="100px">
                ...
                <el-form-item label="联系方式">
                    <el-input v-model="form.telephone" auto-complete="off" placeholder="请输入联系方式"></el-input>
                </el-form-item>
            </el-form>
            <div slot="footer" class="dialog-footer">
    ...
    export default {
        ...
        data() {
            return {
                ...
                p: {
                    addStoreHouse:false,
                    updateStoreHouse:false,
                    updateStoreHouseDeleteById:false,
                },
                isShowOperate: false,
