<template>
    <div>
        <v-breadcrumb :nav="['供应商管理','供应商列表','编辑供应商']"></v-breadcrumb>
        <div class="container">
            <div class="supplier-box">
                <el-form :model="form" ref="form">
                    ...
                    <el-form-item prop="brandIds" label="供应产品品类品牌">
                        <el-transfer :titles="['品牌列表','已选择品牌']" filterable filter-placeholder="请输入品牌名称" v-model="brandIds" :data="brandList">
                        </el-transfer>
                    </el-form-item>
...
export default {
    ...
    methods: {
        ...
        getBrandList() {
            request
                .findProductBrandListNoStop({ name: '' })
                .then(res => {
                    this.brandList = [];
                    this.getDetail();
                    res.data.forEach(v => {
