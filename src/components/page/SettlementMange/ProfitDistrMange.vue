<template>
    <div class="profit-distr-mange">
        ...
        <el-card :body-style="{ padding: '30px' }">
            <el-button v-if="p.operateSettlementConfig" type="primary" style="margin-bottom:10px" @click="createTpl">创建利润模板</el-button>
            <el-table :data="tableData" border>
                ...
                <el-table-column v-if="p.operateSettlementConfig" label="操作" align="center">
                    <template slot-scope="scope">
...
export default {
  ...
  data () {
    return {
        p:{
            operateSettlementConfig:false, // 操作利润分配模版
        },
        tableData:[],
    };
  },
