<template>
    <div class="price-of-inventory">
        ...
        <el-card v-loading="bodyLoading" :body-style="{ padding: '30px' }">
            <p>礼包名称：<el-input disabled class="my-inp" v-model="giftName"></el-input>
            </p>
...
export default {
    ...
    methods: {
        ...
        getPrice() {
            ...
            request
                .findActivityPackageProductAndSpecById({ packageId: this.giftId })
                .then(res => {
        ...
        submitForm() {
            ...
            request
                .updataActivityPackagePriceAndStock(data)
                .then(res => {
