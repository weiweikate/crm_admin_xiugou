        ...
        <el-card v-loading="bodyLoading" :body-style="{ padding: '50px' }">
            ...
            <div v-for="(v,k) in selectedPro" :key="k" style="margin-bottom:10px">
                <table class="selected-product">
                    <tr style="color:#aaa" v-if="selectedPro.length == 0">
                        <td>请选择产品</td>
                    </tr>
...
export default {
    ...
    methods: {
        ...
        getGiftProInfo() {
            ...
            request
                .findActivityPackageProductAndSpecById({
                ...
                .then(res => {
                    res.data.forEach(v => {
                        ...
                        const specWrapArr = [];
                        const skuCode = v.skuCode ? v.skuCode.split(',') : [];
        ...
        submitForm() {
            ...
            request
                .addActivityPackageProduct(data)
                .then(res => {
        ...
        querySearchAsync(queryString, cb) {
            ...
            this.keyWordsID = '';
            request
                .queryProductList({ param: this.keyWords })
                .then(res => {
                    const tmpArr = [];
