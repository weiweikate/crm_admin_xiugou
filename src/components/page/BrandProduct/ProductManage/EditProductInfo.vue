<template>
    <div class="edit-product">
        ...
        <el-card>
            <div v-if="productInfo.thirdCategoryName">
                <span style="font-weight: 900">您当前选择的分类是</span>: {{productInfo.firstCategoryName}} > {{productInfo.secCategoryName}} > {{productInfo.thirdCategoryName}}
        ...
        <el-card>
            <v-prod-param @nextName="getNextName" @productInfo="getProdInfo" :productInfo="productInfo" ref="baseParam"></v-prod-param>
        </el-card>
        <!--<el-card v-loading="pageLoading">-->
            <!--<el-tabs v-model="activeName" type="card" @tab-click="handleClick">-->
                ...
                <!--<el-tab-pane disabled label="库存编辑" name="inventory">-->
                    <!--<v-inventory @nextName="getNextName" @productInfo="getProdInfo" :productInfo="productInfo" ref="inventory"></v-inventory>-->
                <!--</el-tab-pane>-->
                <!--<el-tab-pane disabled label="商品详情编辑" name="info">-->
                    <!--&lt;!&ndash;<v-info ref="info" @isKeepAlive="isKeepAlive" :productInfo="productInfo"></v-info>&ndash;&gt;-->
                <!--</el-tab-pane>-->
            <!--</el-tabs>-->
        <!--</el-card>-->
    </div>
...
export default {
    ...
    created() {
        ...
        let cateArr = JSON.parse(this.$route.query.cate) || [];
        this.productInfo = {
            prodCode: this.prodCode,
            firstCategoryId: cateArr[0].value || 0,
            firstCategoryName: cateArr[0].label || '',
            secCategoryId: cateArr[1].value || 0,
            secCategoryName: cateArr[1].label || '',
            thirdCategoryId: cateArr[2].value || 0,
            thirdCategoryName: cateArr[2].label || '',
            name: '',
            secondName: '',
            supplierCode: '',
            warehouseType: '',
